...
import member4 from "../../../public/images/swapno.webp";
          ...
          <div className="w-[70%] mx-auto">
            <div className="text-center md:px-0 px-5 mb-20">
              ...
              <p className="lg:text-xl md:text-lg text-base font-normal mt-5">
                The volunteers who give their time and talents help to fulfill
                our mission.
              </p>
            </div>
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8">
              <div className="card bg-base-100 rounded-md cursor-pointer shadow-lg hover:transform hover:scale-110 duration-500 hover:shadow-red-100">
                ...
                <div className="card-body items-center text-center">
                  ...
                  <div className="social-icon flex gap-3 text-2xl bottom-0 w-full justify-center py-2 mt-2">
                    <Link
                      href={
                        "https://www.facebook.com/profile.php?id=100035686685884"
                      }
                    >
              ...
              <div className="card bg-base-100 rounded-md cursor-pointer shadow-lg hover:transform hover:scale-110 duration-500 hover:shadow-red-100">
                ...
                <div className="card-body items-center text-center">
                  ...
                  <div className="social-icon flex gap-3 text-2xl bottom-0 w-full justify-center py-2 mt-2">
                    <Link href={"https://www.facebook.com/jpchoyon.khan.130"}>
                      <FaFacebook className="text-[#3b5998] hover-icon"></FaFacebook>{" "}
                    </Link>
                    <FaLinkedin className="text-[#0077b5] hover-icon"></FaLinkedin>
                    <FaInstagram className="text-[#d53f66] hover-icon"></FaInstagram>
              ...
              <div className="card bg-base-100 rounded-md cursor-pointer shadow-lg hover:transform hover:scale-110 duration-500 hover:shadow-red-100">
                ...
                <div className="card-body items-center text-center">
                  ...
                  <p className="">Co-Founder</p>
                  <div className="social-icon flex gap-3 text-2xl bottom-0 w-full justify-center py-2 mt-2">
                    <Link href={"https://www.facebook.com/nazmulhossen539"}>
                      <FaFacebook className="text-[#3b5998] hover-icon"></FaFacebook>{" "}
                    </Link>
                    <Link href={""}>
                      {" "}
              ...
              <div className="card bg-base-100 rounded-md cursor-pointer shadow-lg hover:transform hover:scale-110 duration-500 hover:shadow-red-100">
                ...
                <div className="card-body items-center text-center">
                  <h2 className="card-title text-primary">Swapno Dey</h2>
                  <p className="">Manager</p>
                  <div className="social-icon flex gap-3 text-2xl bottom-0 w-full justify-center py-2 mt-2">
                    <Link href={"https://www.facebook.com/swapno923"}>
                      <FaFacebook className="text-[#3b5998] hover-icon"></FaFacebook>{" "}
                    </Link>
                    <Link
                      href={"https://www.linkedin.com/in/swapno-dey-7135572a5"}
                    >
                      {" "}
                      <FaLinkedin className="text-[#0077b5] hover-icon"></FaLinkedin>
                    </Link>
                    <Link href={"https://www.instagram.com/swapno923"}>
                      <FaInstagram className="text-[#d53f66] hover-icon"></FaInstagram>
                    </Link>
                    <Link href={"https://twitter.com/Swapno23"}>
                      <FaTwitter className="text-[#1DA1F2] hover-icon"></FaTwitter>
                    </Link>
                  </div>
                </div>
