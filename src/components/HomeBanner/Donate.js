...
const Donate = () => {
  ...
  return (
    <>
      {/* if user not avaible */}
      {
        !user && <><Link href={"https://donate.stripe.com/test_cN2eXB6YHbbD784bIJ"}>
          <div className=" w-full md:w-9/12 mx-auto rounded-xl md:my-16 bg-primary md:p-10 p-5 mb-5 lg:mb-0">
      ...
      {/* if user are avaible  */}
      {
        user && <>  <div className="container max-w-7xl mx-auto">
