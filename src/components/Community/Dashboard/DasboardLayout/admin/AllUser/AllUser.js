...
const AllUser = async () => {
  ...
  return (
    <div className=" mb-12 lg:px-4 md:px-2 px-[1px]">
            ...
            {users?.map((user, index) => (
              ...
              >
                ...
                <td className="flex gap-3">
                  <button className="  btn-sm px-6 py-4">
                    <MdEditNote className="text-green-700 text-3xl" />
                  </button>
                  <button className="  btn-sm px-6 py-4">
                    <MdDeleteSweep className="text-red-600 text-2xl" />
                  </button>
                </td>
              </tr>
            ))}
