...
import { FaHome, FaPhoneAlt, FaRegEnvelope, FaGlobe, FaFacebook, FaLinkedin, FaInstagram, FaTwitter  } from "react-icons/fa";
            ...
            <div className="max-w-screen-xl mx-auto my-28">
                <div className="lg:flex lg:px-0 md:px-10 px-5">
                    ...
                    <div className="lg:w-1/2 w-full lg:mt-0 mt-14">
                        <div className="mb-8">
                            <h2 className="text-2xl font-semibold uppercase">Need Blood? Contact Us</h2>
                        </div>
                        <div>
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body p-0 my-5">
                                ...
                                <div className="form-control mt-3">
                                    <input {...register("subject")} type="text" placeholder="Subject..." className="input focus:border-0 focus-within:outline-none border-0 border-b-2 border-gray-400 focus:border-b-2 focus:border-primary rounded-none px-1" />
                                </div>

                                <div className="form-control mt-3">
                                    <textarea {...register("subject", { required: true })} type="text" placeholder="What's on your mind..." className="textarea textarea-lg focus:border-0 focus-within:outline-none border-0 border-b-2 border-gray-400 focus:border-b-2 focus:border-primary rounded-none px-1" />
                                    {errors.subject && <span className='text-red-600 text-sm mt-2'>Write something about your needed blood*</span>}
                                </div>
                                <div className="form-control mt-6">
                                    <button className="btn bg-primary border-0 hover:bg-secondary text-white text-lg shadow-lg shadow-primary/30 rounded-sm">Send</button>
                                </div>
                            </form>
                        </div>
                    </div>
